...
export const gridItems = [
  {
    id: 1,
    title:
      "I turn a genuine conversations into websites that capture your unique vision. ",
    description: "",
  ...
  {
    id: 4,
    title: "Tech enthusiast who brings ideas to life through code.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently running Sole Media, the marketing agency i co-founded",
...
export const testimonials = [
  {
    quote:
      "I was really impressed by how well Michael listened and understood our vision. He turned our ideas into a beautiful, easy-to-use website that perfectly captures the spirit of our social events. I couldn't be happier!",
    name: "Emily",
    title: "Founder of Social Sphere",
  },
  {
    quote:
      "Michael truly exceeded our expectations. His friendly approach made the whole process so smooth, and our new website is both beautiful and easy to navigate. I couldn’t be happier with the results.",
    name: "Azra",
    title: "Owner, Eden International",
  },
  {
    quote:
      "Michael delivered an outstanding website for us the first time, and when we needed a refresh, we knew he was the one to call again. His friendly approach and commitment to quality truly set him apart—this is our second time working with him, and we're even more impressed with the results!",
    name: "Azra",
    title: "Founder of Quality Care Providers",
  },
  {
    quote:
      "Michael's work completely transformed our online presence. His attention to detail and clear understanding of our business made the process effortless, and our website looks fantastic. We're thrilled with the results!",
    name: "Glen Farolan",
    title: "Founder, Mould & Restoration",
  },
  {
    quote:
      "Michael's work revitalized our digital presence. His modern design and meticulous attention to detail have made it easier for our audience to connect with our events. We’re excited about what the future holds.",
    name: "Azra",
    title: "founder, MOR Events",
  },
];
...
export const certificates = [
  {
    id: 1,
    title: "AcademyXi Full Stack Software Engineering (Transform)",
  ...
  {
    id: 2,
    title: "Programming for Everybody (Coursera)",
    desc: "Completed the foundational programming course by Coursera, taught by Dr. Charles Severance.",
  ...
  },
  {
    ...
    desc: "Earned a certificate for completing Google's beginner-friendly crash course on Python.",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  {
    id: 4,
    title: "Google Intro to Git and GitHub",
    desc: "Learned the essentials of version control and collaboration with Git and GitHub.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
